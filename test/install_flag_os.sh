...
show_help() {
  echo ""
  echo "Usage: xui-rp-install-server.sh [-u|--utils <true|false>] [-d|--dns <true|false>] [-a|--addu <true|false>]"
  ...
  echo "       [-f|--firewall <true|false>] [-s|--ssh <true|false>] [-t|--tgbot <true|false>] [-h|--help]"
  echo ""
  ...
  echo "  -m, --mon <true|false>         Monitoring services (e.g., node_exporter) (default: ${defaults[mon]})"
  ...
  echo "  -t, --tgbot <true|false>       Telegram bot integration for user management (default: ${defaults[tgbot]})"
